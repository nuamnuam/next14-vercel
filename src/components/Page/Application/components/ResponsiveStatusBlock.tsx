  ...
  return (
    ...
    >
      ...
      {update != null && (
        <Card
          classNames={clsx(
            ' left-[-252px] absolute px-6 py-5',
            cardClassName,
            direction !== 'to-top'
              ? 'top-[28px] right-[-318px] w-fit'
              : 'top-[29px]',
        ...
        >
          ...
          <p className="text-base	font-bold text-dark-700	">{update?.title}</p>
          {update?.description ? (
            <p
          ...
          {update.updatedAt ? (
            <p className="mt-4 text-sm font-medium text-dark-300">
              ...
              {timestampToPersianDate(update.updatedAt)}
            </p>
          ) : null}
        </Card>
      )}
